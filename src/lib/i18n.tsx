...
const translations = {
  bg: {
    ...
    views: {
      ...
      gurkoP1: "Това е старата главна улица на града със запазени автентични сгради от средновековието и за това е архитектурен резерват. По ул.Ген Гурко са минавали исторически личности и български революционери и са разположени редица музеи, къщи механи и ресторанти в сгради на по-вече 2 века. За това ул.Гурко е една от основните туристически забележителности на град Велико Търново, която привлича множество чуждестранни посетители от цял свят.",
      gurkoP2: "Улица Генерал Гурко е една от най-красивите и емблематични улици на Велико Търново. Калдъръмената улица се вие по склона над река Янтра, обградена от автентични възрожденски къщи с характерни еркери, дървени чардаци и цветя по фасадите.",
      gurkoP3: "От улицата се откриват захласващи панорамни гледки към река Янтра, старите квартали и хълмовете наоколо. Това е мястото, където историята и красотата се преплитат във всяка крачка.",
    },
  ...
  en: {
    ...
    views: {
      ...
      gurkoP1: "This is the old main street of the city with preserved authentic buildings from the Middle Ages, which is why it is an architectural reserve. Along Gen. Gurko Street, historical figures and Bulgarian revolutionaries once walked, and numerous museums, houses, taverns, and restaurants are located in buildings over 2 centuries old. That is why Gurko Street is one of the main tourist attractions of the city of Veliko Tarnovo, attracting many foreign visitors from all over the world.",
      gurkoP2: "General Gurko Street is one of the most beautiful and iconic streets of Veliko Tarnovo. The cobblestone road winds along the slope above the Yantra River, lined with authentic Revival houses featuring characteristic bay windows, wooden balconies, and flowers on the facades.",
      gurkoP3: "From the street, breathtaking panoramic views open up toward the Yantra River, the old quarters, and the surrounding hills. This is where history and beauty intertwine with every step.",
    },
  ...
  ro: {
    ...
    views: {
      ...
      gurkoP1: "Aceasta este vechea stradă principală a orașului, cu clădiri autentice conservate din Evul Mediu, motiv pentru care este rezervație arhitecturală. Pe str. Gen. Gurko au trecut personalități istorice și revoluționari bulgari, iar de-a lungul ei se află numeroase muzee, case, taverne și restaurante în clădiri vechi de peste 2 secole. De aceea str. Gurko este una dintre principalele atracții turistice ale orașului Veliko Târnovo, atrăgând mulți vizitatori străini din întreaga lume.",
      gurkoP2: "Strada General Gurko este una dintre cele mai frumoase și emblematice străzi din Veliko Târnovo. Drumul pavat se întinde de-a lungul versantului de deasupra râului Yantra, înconjurat de case autentice în stil Renascenţist cu balcoane din lemn și flori pe fațade.",
      gurkoP3: "De pe stradă se deschid vederi panoramice uimitoare spre râul Yantra, cartierele vechi și dealurile împrejurătoare. Aici istoria și frumusețea se împletesc la fiecare pas.",
    },
