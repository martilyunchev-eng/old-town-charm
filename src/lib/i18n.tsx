...
const translations = {
  bg: {
    ...
    rooms: {
      ...
      room1: "Стая 101 – Двойна супериорна",
      room1floor: "Етаж 1",
      room1features: [
        "Голямо двойно легло",
        "Кухненски бокс (мивка и керамичен плот)",
        "Без балкон",
        "Гледка към улицата и стария град",
        "Самостоятелна баня",
      ],
      room2: "Апартамент 201",
      room2floor: "Етаж 2",
      room2features: [
        "Две спални",
        "Кухненски бокс (мивка и керамичен плот)",
  ...
  en: {
    ...
    rooms: {
      ...
      room1features: [
        "Large double bed",
        "Kitchenette (sink and ceramic hob)",
        "No balcony",
        "View of the street and old town",
        "Private bathroom",
      ],
      room2: "Apartment 201",
      room2floor: "Floor 2",
  ...
  ro: {
    ...
    rooms: {
      ...
      room1features: [
        "Pat dublu mare",
        "Chicineta (chiuvetă și plită ceramică)",
        "Fără balcon",
        "Vedere spre stradă și orașul vechi",
        "Baie privată",
      ],
      room2: "Apartament 201",
      room2floor: "Etajul 2",
      room2features: [
        "Două dormitoare",
        "Chicineta (chiuvetă și plită ceramică)",
